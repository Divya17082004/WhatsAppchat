  ...
  <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
    ...
    >
        ...
        <View style={styles.header}>
            ...
            <Ionicons name="arrow-back" size={24} color="white" style={{ marginTop: 30 }} />
            </TouchableOpacity>

            {/* Avatar — photo if available, else initials */}
            {thumbnailPath ? (
            <Image source={{ uri: thumbnailPath }} style={styles.avatarImage} />
            ) : (
    ...
    <TouchableOpacity style={styles.iconBtn}>
        <Ionicons name="attach" size={22} color="#777" />
    </TouchableOpacity>
